{# This is the default version of the stage macro, designed for SqlServer. #}

{%- macro sqlserver__stage(include_source_columns,
                ldts,
                rsrc,
                source_model,
                hashed_columns,
...
{%- set hash_dtype = var('datavault4dbt.hash_datatype', 'BINARY(20)') -%}
